...
export default function wrapper({ children }) {
  return (
    <>
      <Meta
        description="React Calendar Views page: React Calendar Views page: Explore our React Lightweight Calendar Component documentation! A powerful, customizable tool for visualizing entities, perfect for tailored calendar solutions. Learn more here."
