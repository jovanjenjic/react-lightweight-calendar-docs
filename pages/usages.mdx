...
export default function wrapper({ children }) {
  return (
    <>
      <Meta
        description="Learn practical examples and best practices for using react-lightweight-calendar. Discover various usage scenarios to effectively integrate our React calendar component into your projects."
        keywords="react calendar usage, react-lightweight-calendar usage, using react calendar, react calendar examples, calendar component usage react"
        title="React-Lightweight-Calendar Usage: Best Practices and Tips"
