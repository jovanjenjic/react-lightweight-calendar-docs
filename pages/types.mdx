...
export default function wrapper({ children }) {
  return (
    <>
      <Meta
        description="Discover how to use TypeScript with react-lightweight-calendar. Explore the various TypeScript types and how they enhance your React calendar component for a robust development experience."
        keywords="react calendar typescript, react-lightweight-calendar types, typescript react calendar component, react calendar types guide, typescript calendar integration"
        title="Using TypeScript with React-Lightweight-Calendar: A Complete Guide"
